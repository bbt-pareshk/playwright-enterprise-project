...
export const ROUTE_PATHS = {
  ...
  WELCOME: '/welcome',
  ONBOARDING: '/welcome',
  HOSTING_PLAN: '/welcome/hosting-plan',
  HOSTING_PAYMENT: '/welcome/hosting-payment',
  PROFILE: '/profile',
  PAYMENT: '/payment',
...
export const ROUTES = {
  ...
  onboarding: () => `${ENV.BASE_URL}${ROUTE_PATHS.ONBOARDING}`,
  hostingPlan: () => `${ENV.BASE_URL}${ROUTE_PATHS.HOSTING_PLAN}`,
  hostingPayment: (plan: string) => `${ENV.BASE_URL}${ROUTE_PATHS.HOSTING_PAYMENT}?plan=${plan}`,
